...
import ernazarImg from "@/public/ernazar.jpeg";
...
export default function Intro() {
  ...
  return (
    ...
    >
      ...
      >
        <span className="font-bold">Hello, I am Ernazar.</span> I am a{" "}
        <span className="font-bold">full-stack developer</span> with{" "}
        <span className="font-bold">2 years</span> of experience. I enjoy
        building <span className="italic">webApps</span>. My focus is{" "}
      ...
      >
        ...
        <a
          className="bg-white  p-4 text-gray-700 hover:text-gray-950 flex items-center gap-2 rounded-full focus:scale-[1.15] hover:scale-[1.15]  active:scale-105
          transition cursor-pointer borderBlack dark:bg-white/10 dark:text-white/60"
          href="https://www.linkedin.com/in/ernazarakteke/"
          target="_blank"
        >
          <BsLinkedin />
        </a>
        ...
        <a
          ...
          transition cursor-pointer borderBlack dark:bg-white/10 dark:text-white/60"
          href="https://github.com/ernazarakteke"
          target="_blank"
        >
          <FaGithubSquare />
        </a>

...
export const metadata = {
  title: "Ernazar | Personal Portfolio",
  description: "Ernazar is a young software developer",
};
...
export default function RootLayout({
  ...
  return (
    <html lang="en" className="!scroll-smooth">
      ...
      >
        <div
          className="bg-[#a3cef1] absolute  
        top-[-6rem] -z-10 right-[11rem] h-[31.25rem] w-[31.25rem] rounded-full blur-[10rem]
         sm:w-[68.75rem] dark:bg-[#3b4f76]"
        ></div>
        <div
          className="bg-[#a3e4d7] absolute  
        top-[-1rem] -z-10 left-[-35rem] h-[31.25rem] w-[50rem] rounded-full blur-[10rem]
         sm:w-[68.75rem]
         md:left-[-33rem] lg:left-[-28rem] xl-left-[-15rem] 2xl-left-[-5rem] dark:bg-[#2c6357]"
        ></div>
